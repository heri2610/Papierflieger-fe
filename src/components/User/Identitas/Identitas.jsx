            ...
            <li className="event" data-date={`${ticket.arrivalTime.split(':')[0]}:${ticket.arrivalTime.split(':')[1]}`} data-day="16 Desember">
              ...
              <Col className="mt-5 mx-3 mb-5 rounded text-white">
                ...
                <Form onSubmit={submitOrder}>
                  <Accordion>
                    {ticket.ticketType === 'Internasional' ? penumpangs.map((item,index)=> <Accordion.Item eventKey={index+1}>
                      <Accordion.Header>Penumpang {index+1}</Accordion.Header>
                      <Accordion.Body>
                        <Row>
                          <Col md={12} className="mb-3">
                            <Form.Label className="m-0">Nama Lengkap</Form.Label>
                            <Form.Control placeholder="Full Name" onChange={handleChange(index)} name='passengerName'/>
                          </Col>
                          <Col md={12} className="mb-3">
                          ...
                          <Col md={12} className="mb-3">
                            ...
                            <Form.Control placeholder="Nomor Identitas Passport" onChange={handleChange(index)} name='passportNumber'/>
                          </Col>
                          <Col md={12} className="mb-3">
                            <Form.Label className="m-0">Kebangsaan</Form.Label>
                            <Form.Control placeholder="Kebangsaan" onChange={handleChange(index)} name='nationality' />
                          </Col>
                          <Col md={12} className="mb-3">
                            <Form.Label className="m-0">Email</Form.Label>
                            <Form.Control placeholder="Email" onChange={handleChange(index)} name='email' />
                          </Col>
                          <Col md={12} className="mb-3">
                    ...
                    </Accordion.Item>):penumpangs.map((item,index)=> <Accordion.Item eventKey={index+1}>
                      <Accordion.Header>Penumpang {index+1}</Accordion.Header>
                      <Accordion.Body>
                        <Row>
                          <Col md={12} className="mb-3">
